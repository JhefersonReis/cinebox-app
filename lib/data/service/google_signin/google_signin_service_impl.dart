...
class GoogleSigninServiceImpl implements GoogleSigninService {
  ...
  Future<Result<String>> isSignedIn() async {
    try {
      ...
      log('User is not signed in Google', name: 'GoogleSignInService', error: e, stackTrace: s);
  ...
  Future<Result<String>> signIn() async {
    try {
      ...
      log('Failed to retrieve ID Token from Google Sign-In', name: 'GoogleSignInService', error: e, stackTrace: s);
  ...
  Future<Result<Unit>> signOut() async {
    try {
      ...
      log('Failed to logout', name: 'GoogleSignInService', error: e, stackTrace: s);

      return Failure(Exception('Failed to logout'));
    }
  }
}
